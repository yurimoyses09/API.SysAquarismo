...
public class Peixe
{
    ...
    public Peixe(int id, int id_Usuario, string ds_Nome_Peixe, string ds_Nome_Especie, string ds_Descricao, double? vl_Peso, int? vl_Tamanho, DateTime? ds_Data_Morte, byte[] ds_Imagem, string ds_status_Saude, string ds_doenca, DateTime ds_Data_Aquisicao)
    {
        Id = id;
